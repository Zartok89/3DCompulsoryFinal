...
public:
    /*
    * Transform contains several vectors: Position (X, Y, Z), Rotation (Roll, Pitch, Yaw) and Scale
    */
    Transform()
    ...
    */
    ...
    /*
    * Setting transforms to an actor
    */
    ...
    /*
    * Getting transformation information about an actor
    */
